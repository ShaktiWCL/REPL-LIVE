report 50071 "STLCF-Actual_Recpt_Parent_Proj"
{
    // Actual Receipt (Parent Proj)
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/STLCFActualRecptParentProj.rdl';
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
            {
                ...
                dataitem(Actual_Receipt_Parent_Proj; "Detailed Cust. Ledg. Entry")
                {
                ...
                dataitem(Actual_Receipt_Parent_Proj1; "Detailed Cust. Ledg. Entry")
                {
        ...
        dataitem(Integer; Integer)
        {
            ...
            column(Project_No; TempCashFlowBuffer."Code 3")
            {
            }
