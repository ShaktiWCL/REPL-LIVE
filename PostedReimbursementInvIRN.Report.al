report 70110 "Posted Reimbursement Inv_IRN"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/PostedReimbursementInvIRN.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(AcknowledgementDate_SalesInvoiceHeader; "Sales Invoice Header"."Acknowledgement Date")
            {
            }
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                column(bill_month; "Billing Month")
                {
                }
                column(AmountToCustomer_SalesLine; Amount + SGSTAmount + CGSTAmount + IGSTAmount)
                {
                }
                ...
                begin
                    ...
                    "Sales Invoice Header".CALCFIELDS(Amount, "Total SGST Amount", "Total CGST Amount", "Total IGST Amount");
                    Check.InitTextVariable;
                    Check.FormatNoText(AmountInWord, ("Sales Invoice Header".Amount + "Sales Invoice Header"."Total SGST Amount" + "Sales Invoice Header"."Total CGST Amount" + "Sales Invoice Header"."Total IGST Amount"), "Sales Invoice Header"."Currency Code");
                end;
            }
