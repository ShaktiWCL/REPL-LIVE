report 50002 "Posted Sales Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/PostedSalesInvoice.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(BilltoAddress_SalesHeader; "Sales Invoice Header"."Ship-to Address")
            {
            }
            column(BilltoAddress2_SalesHeader; "Sales Invoice Header"."Ship-to Address 2")
            {
            }
            column(BilltoCity_SalesHeader; "Sales Invoice Header"."Ship-to City")
            {
            }
            column(BilltoContact_SalesHeader; "Sales Invoice Header"."Ship-to Contact")
            {
            }
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                begin
                    ...
                    // Check.FormatNoText(AmountInWord, "Sales Invoice Header"."Amount to Customer", "Sales Invoice Header"."Currency Code");
                end;
            }
