report 50114 "Credit Note GST"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/CreditNoteGST.rdl';
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            column(ShipTo_Name; "Sales Cr.Memo Header"."Ship-to Name")
            {
            }
            column(ShipTo_Address; "Sales Cr.Memo Header"."Ship-to Address")
            {
            }
            column(ShipTo_Address2; "Sales Cr.Memo Header"."Ship-to Address 2")
            {
            }
            column(ShipTo_City; "Sales Cr.Memo Header"."Ship-to City")
            {
            }
            ...
            dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
            {
                ...
                begin
                    ...
                    // ServiceTaxSetup.SETRANGE("From Date", 0D, "Sales Cr.Memo Header"."Posting Date");
                    ...
                    Check.FormatNoText(AmountInWord, "Sales Cr.Memo Header".Amount, "Sales Cr.Memo Header"."Currency Code");
                end;
            }
