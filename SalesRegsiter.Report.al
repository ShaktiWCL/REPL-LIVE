report 50091 "Sales Regsiter"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/SalesRegsiter.rdl';
    ...
    dataset
    {
        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
            {
                ...
                column(CGST_Amount2; ABS(CGSTAmount))
                {
                }
                column(SGST_Amount2; ABS(SGSTAmount))
                {
                }
                column(IGST_Amount2; ABS(IGSTAmount))
                {
                }
