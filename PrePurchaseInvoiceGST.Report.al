report 50118 "Pre Purchase Invoice GST"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/PrePurchaseInvoiceGST.rdl';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(BilltoCustomerNo_SalesHeader; "Purchase Header"."Buy-from Vendor No.")
            {
            }
            column(BilltoName_SalesHeader; "Purchase Header"."Buy-from Vendor Name")
            {
            }
            column(BilltoName2_SalesHeader; "Purchase Header"."Buy-from Vendor Name 2")
            {
            }
            column(BilltoAddress_SalesHeader; "Purchase Header"."Buy-from Address")
            {
            }
            column(BilltoAddress2_SalesHeader; "Purchase Header"."Buy-from Address 2")
            {
            }
            column(BilltoCity_SalesHeader; "Purchase Header"."Buy-from City")
            {
            }
            column(BilltoContact_SalesHeader; "Purchase Header"."Buy-from Contact")
            {
            }
            ...
            column(TDS_Amount; "Purchase Header"."TDS Amount")
            {
            }
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                begin
                    ...
                    Check.FormatNoText(AmountInWord, ROUND("Purchase Header".Amount - "Purchase Header"."TDS Amount", 1), "Purchase Header"."Currency Code");
                end;
            }
            ...
            begin
                ...
                IF UseAsInvoice THEN BEGIN
                    UseAsInvoiceText[1] := 'Pre Purchase Invoice';
                    UseAsInvoiceText[2] := 'Pre Purch. Inv. No.';
                    UseAsInvoiceText[3] := 'Pre Purch. Inv. Date';
                    UseAsInvoiceText[4] := 'Pre Purch. Inv. Curr.';
                END ELSE BEGIN
                    UseAsInvoiceText[1] := 'Pre Purchase Invoice';
                    UseAsInvoiceText[2] := 'Pre Purch. Inv. No.';
                    UseAsInvoiceText[3] := 'Pre Purch. Inv. Date';
                ...
                "Purchase Header".CALCFIELDS("TDS Amount")
            end;
