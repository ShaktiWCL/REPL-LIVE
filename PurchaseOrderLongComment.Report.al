report 50146 "Purchase Order- Long Comment"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/PurchaseOrderLongComment.rdl';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(VendGSTNo; Vend."GST Registration No.")
            {
            }
            ...
            column(Terms_Conditions; "Purchase Header"."Terms Conditions")
            {
            }
            column(Terms_Conditions2; "Purchase Header"."Terms Conditions 2")
            {
            }
