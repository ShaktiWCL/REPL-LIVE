report 50097 "Vendor Aging"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/VendorAging.rdl';
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            begin
                ...
                TempCashFlowBuffer."Code 1" := Vendor."No.";
                TempCashFlowBuffer."Text 1" := Vendor.Name;
    ...
    var
        ...
        ColCount: Integer;
        AgedAccReceCap: Label 'Aged Accounts Payable';
    ...
    begin
        ...
        VendLedgerEntry.SETCURRENTKEY("Vendor No.", "Global Dimension 1 Code", "Global Dimension 2 Code", "Posting Date", "Currency Code");
        VendLedgerEntry.SETRANGE("Vendor No.", Vendor."No.");
        VendLedgerEntry.SETRANGE("Vendor No.", Vendor."No.");
        VendLedgerEntry.SETFILTER("Global Dimension 1 Code", Vendor."Global Dimension 1 Filter");
        IF Vendor.GETFILTER("Global Dimension 2 Filter") <> '' THEN
            VendLedgerEntry.SETFILTER("Global Dimension 2 Code", Vendor."Global Dimension 2 Filter");
        VendLedgerEntry.SETFILTER("Posting Date", '..%1', EndingDate);
        IF Vendor.GETFILTER("Currency Filter") <> '' THEN
            VendLedgerEntry.SETFILTER("Currency Code", Vendor."Currency Filter");
        IF VendLedgerEntry.FINDSET THEN BEGIN
            REPEAT
                ...
                DetVendLedgEntry.SETRANGE("Vendor Ledger Entry No.", VendLedgerEntry."Entry No.");
                DetVendLedgEntry.SETFILTER("Posting Date", '..%1', EndingDate);
                IF DetVendLedgEntry.FINDSET THEN BEGIN
                    REPEAT
                        RemaingValueCal += DetVendLedgEntry."Amount (LCY)";
                    UNTIL DetVendLedgEntry.NEXT = 0;
                END;

                CalDays := EndingDate - VendLedgerEntry."Posting Date";
                ...
                BalanceAmount += VendLedgerEntry."Amount (LCY)";
    ...
    begin
        //ExcelBuf.CreateBookAndOpenExcel('Vendor Aging','Vendor Aging',COMPANYNAME,USERID);
        ERROR('');
    end;
    ...
    begin
        ...
        ExcelBuf.NewRow;
        ExcelBuf.AddColumn('Report Name: Vendor Aging', FALSE, '', TRUE, TRUE, FALSE, '', ExcelBuf."Cell Type"::Text);
        ExcelBuf.NewRow;
