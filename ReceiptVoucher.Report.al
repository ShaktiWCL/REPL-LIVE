report 50115 "Receipt Voucher"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/ReceiptVoucher.rdl';
    ...
    dataset
    {
        dataitem("Detailed GST Ledger Entry"; "Detailed GST Ledger Entry")
        {
            ...
            column(Location_StateName; '')
            {
            }
            column(Location_StateCode; '')
            {
            }
    ...
    var
        ReceiptVoucherCap: Label 'Receipt Voucher';
        ...
        ReverseChargeCap: Label 'Reverse Charge';
        SnCap: Label 'SN';
        ...
        GetLocationState: Record Location;
