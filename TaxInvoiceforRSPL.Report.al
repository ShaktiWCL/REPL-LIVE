report 50096 "Tax Invoice for RSPL"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/TaxInvoiceforRSPL.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                column(Unit_Price_SalesLine; "Sales Invoice Line"."Unit Price")
                {
                }
                ...
                begin
                    ...
                    DiscountVal := 0;
                    DiscountVal := "Sales Invoice Line"."Line Discount Amount" + "Sales Invoice Line"."Inv. Discount Amount";
