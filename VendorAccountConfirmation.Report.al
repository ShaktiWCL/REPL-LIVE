report 50108 "Vendor Account Confirmation"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/VendorAccountConfirmation.rdl';
    ...
    dataset
    {
        dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
        {
            ...
            column(Vend_Ledger_Entry_Vendor_No_; "Vendor Ledger Entry"."Vendor No.")
            {
            }
            column(Vend_Ledger_Entry_Posting_Date_; FORMAT("Vendor Ledger Entry"."Posting Date"))
            {
            }
            column(Vend_Ledger_Entry_Document_No_; "Vendor Ledger Entry"."Document No.")
            {
            }
            column(Vend_Ledger_Entry_Description; "Vendor Ledger Entry".Description + ' - ' + "External Document No.")
            {
            }
            column(Vend_Ledger_Entry_Credit_Amount; ROUND("Vendor Ledger Entry"."Credit Amount (LCY)", 0.01))
            {
            }
            column(Vend_Ledger_Entry_Debit_Amount; ROUND("Vendor Ledger Entry"."Debit Amount (LCY)", 0.01))
            {
            }
            column(Vendor_Ledger_Entry_Amount; "Vendor Ledger Entry"."Amount (LCY)")
            {
            }
            column(Vend_Ledger_Entry_Document_Type; "Vendor Ledger Entry"."Document Type")
            {
            }
            ...
            begin
                ...
                IF "Vendor No." <> TempVendNo THEN BEGIN
                    OpeningBalance := 0;
                    VendLedgEntry.RESET;
                ...
                ReportCheck.FormatNoText(AmountInWords, ABS(RunningBalance), '');
