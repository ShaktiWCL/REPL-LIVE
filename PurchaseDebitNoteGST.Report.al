report 50136 "Purchase Debit Note GST"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/PurchaseDebitNoteGST.rdl';
    ...
    dataset
    {
        dataitem("Purch. Cr. Memo Hdr."; "Purch. Cr. Memo Hdr.")
        {
            ...
            column(BilltoCustomerNo_SalesHeader; "Buy-from Vendor No.")
            {
            }
            column(BilltoName_SalesHeader; "Buy-from Vendor Name")
            {
            }
            column(BilltoName2_SalesHeader; "Buy-from Vendor Name 2")
            {
            }
            column(BilltoAddress_SalesHeader; "Buy-from Address")
            {
            }
            column(BilltoAddress2_SalesHeader; "Buy-from Address 2")
            {
            }
            column(BilltoCity_SalesHeader; "Buy-from City")
            {
            }
            column(BilltoContact_SalesHeader; "Buy-from Contact")
            {
            }
            ...
            dataitem("Purch. Cr. Memo Line"; "Purch. Cr. Memo Line")
            {
                ...
                begin
                    ...
                    Check.FormatNoText(AmountInWord, ROUND("Purch. Cr. Memo Hdr.".Amount, 1), "Purch. Cr. Memo Hdr."."Currency Code");
                end;
            }
            ...
            begin
                ...
                IF UseAsInvoice THEN BEGIN
                    UseAsInvoiceText[1] := 'Purchase Debit Note';
                    UseAsInvoiceText[2] := 'Purch. Debit Note No.';
                    UseAsInvoiceText[3] := 'Purch. Debit Note Date';
                    UseAsInvoiceText[4] := 'Purch. Debit Note Curr.';
                END ELSE BEGIN
                    UseAsInvoiceText[1] := 'Purchase Debit Note';
                    UseAsInvoiceText[2] := 'Purch. Debit Note No.';
                    UseAsInvoiceText[3] := 'Purch. Debit Note Date';
