report 90147 "SUDA Posted Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/SUDAPostedInvoice.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(Cust_code; "Sales Invoice Header"."Bill-to Customer No.")
            {
            }
            ...
            column(cust_location_code; "Sales Invoice Header"."Location State Code")
            {
            }
            ...
            column(pay_term; "Sales Invoice Header"."Payment Terms Code")
            {
            }
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                begin
                    ...
                    DiffMessage := (Value - "Sales Invoice Header".Amount);
                    ...
                    IF SIL.FINDFIRST THEN BEGIN
                        REPEAT
                            TotalValue := (SIL."General/OBC" * RateValue) + (SIL.SC * RateValue) + (SIL.ST * RateValue);
                        UNTIL SIL.NEXT = 0;
                    END;
                    ...
                    Check.FormatNoText(AmountInWord, ROUND("Sales Invoice Header".Amount, 1), "Sales Invoice Header"."Currency Code");


                    IF companyinfo.Name = 'Rudrabhishek Enterprises Limited' THEN BEGIN
                        IF "Sales Invoice Header"."Bank Account No." <> '' THEN
                            Bankname.GET("Sales Invoice Header"."Bank Account No.")
                        ELSE
