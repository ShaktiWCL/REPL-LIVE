report 60103 "EPP Report List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/EPPReportList.rdl';
    ...
    dataset
    {
        dataitem(Project; Job)
        {
            ...
            column(ProjectStartDate_Project; Project."Starting Date")
            {
            }
            column(ProjectEndDate_Project; Project."Ending Date")
            {
            }
            column(AgreementFromDate_Project; Project."Agreement From Date")
            {
            }
            ...
            column(EstimatedProjectCost_Project; Project."Estimated Project Cost")
            {
            }
            column(ProjectManager_Project; Project."Project Manager")
            {
            }
            ...
            dataitem(ActulOutSource; Job)
            {
                ...
                column(ActualOutSouDes; ActulOutSource.Description + ' ' + ActulOutSource."Description 2")
                {
                }
            ...
            begin
                ...
                */
                ...
                RecVendor.RESET;
                RecVendor.SETFILTER("Exclude EPP", '%1', FALSE);
                IF RecVendor.FINDFIRST THEN BEGIN
                    REPEAT
                        PurchInvHeader.RESET;
                        PurchInvHeader.SETRANGE("Shortcut Dimension 1 Code", Project."Global Dimension 1 Code");
                        PurchInvHeader.SETFILTER("Buy-from Vendor No.", '%1', RecVendor."No.");
                        IF PurchInvHeader.FIND('-') THEN BEGIN
                            TotalNoInv := PurchInvHeader.COUNT;
                            REPEAT
                                PurchInvHeader.CALCFIELDS(Amount);
