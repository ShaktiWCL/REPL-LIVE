report 60102 "EPP Report Ex. EPP"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/EPPReportExEPP.rdl';
    ...
    dataset
    {
        dataitem(Project; Job)
        {
            ...
            begin
                ...
                GLEntry.SETFILTER("Exclude EPP", '%1', FALSE);
                ...
                IF RecVendor.FINDFIRST THEN BEGIN
                    REPEAT
                        ...
                        PurchHead.SETRANGE(PurchHead."Buy-from Vendor No.", RecVendor."No.");
                ...
                IF RecVendor.FINDFIRST THEN BEGIN
                    REPEAT
                        ...
                        PurchCrHead.SETFILTER("Buy-from Vendor No.", '%1', RecVendor."No.");
